...
const getCustomRedirect = (name, link) => {
  const lowerName = (name || "").toLowerCase().trim();
  const lowerLink = (link || "").toLowerCase().trim();
  
  if (lowerName === "free art education" || lowerLink === "free-art-education") return "/Petals/Kala-Deeksha";
  
  if (
    lowerName === "karagar ke kalalkar" || 
    lowerName === "karagaar ke kalakaar" || 
    lowerName === "karagaar ke kalaakar" || 
    lowerLink === "karagaar-ke-kalaakar" ||
    lowerLink === "karagar-ke-kalalkar"
  ) return "/Petals/Karagaar-Ke-Kalaakar";
  
  if (
    lowerName === "colors of the corporate" || 
    lowerLink === "colors-of-the-corporate" ||
    lowerName === "corporate colors" ||
    lowerLink === "corporate-colors"
  ) return "/Petals/Colors-of-the-Corporate";
                            ...
                            {LinkMenu.filter(linkItem => linkItem.sub_menu_id === submenu.id).map((item) => (
                              <Link
                                ...
                                href={
                                  item.Custom_Link === 1
                                    ? item.link
                                    : getCustomRedirect(item.name, item.link) || (
